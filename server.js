...
http.createServer(function(req, res){
    ...
    if( req.method == "GET"){
        ...
        else if(req.url.match("?code=4/rgHTTCPASzRDPgIb3CvMdCfe3tJNQP1mRUEi34u0EvHb5Tr3J8SwG4K7Fkj4-4TT9-hyiRtC5AGp8Ajb3M4u57Q&scope=https://www.googleapis.com/auth/youtube.readonly")){
          console.log("my");
        }
        //404 PAGE NOT FOUND
        else{
