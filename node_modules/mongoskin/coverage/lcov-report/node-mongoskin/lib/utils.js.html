...
<div class="header high">
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">node-mongoskin/lib/</a> &#187; utils.js</div>
</div>
<div class="body">
...
&nbsp;
  SkinClass._bindSetter = function(propName) {
      SkinClass.prototype.__defineSetter__(propName, function(value) {
          ...
          this.open(function(err, p_native) {
              <span class="missing-if-branch" title="if path not taken" >I</span>if(err) <span class="cstat-no" title="statement not covered" >return onError(err, args, skinClassName + '.' + propName);</span>
